...
class TestTassi:
    ...
    def test_make_request_success(self, m):
    ...
    @requests_mock.Mocker()
    def test_make_request_authentication_error(self, m):
    ...
    @requests_mock.Mocker()
    def test_make_request_not_found_error(self, m):
    ...
    @requests_mock.Mocker()
    def test_make_request_validation_error(self, m):
    ...
    @requests_mock.Mocker()
    def test_create_shipment(self, m):
    ...
    @requests_mock.Mocker()
    def test_update_package(self, m):
    ...
    @requests_mock.Mocker()
    def test_track_package(self, m):
        """Test de suivi d'un package."""
        package_id = "pkg_123"
        expected_response = {"tracking_events": [], "current_status": "in_transit"}
        m.get(
            f"{self.tassi.base_url}/packages/{package_id}/track", json=expected_response
        )
    ...
    @requests_mock.Mocker()
    def test_update_carrier(self, m):
    ...
    @requests_mock.Mocker()
    def test_update_marketplace(self, m):
    ...
    @requests_mock.Mocker()
    def test_get_marketplace_wallet_history(self, m):
        ...
        m.get(
            f"{self.tassi.base_url}/marketplaces/{marketplace_id}/wallet_history",
            json=expected_response,
        )
    ...
    @requests_mock.Mocker()
    def test_get_marketplace_wallet_history_with_params(self, m):
        """Test de récupération de l'historique avec paramètres."""
        marketplace_id = "mkt_123"
        params = {"page": 2, "per_page": 10}
        expected_response = {"wallet_movements": [], "meta": {}}
        m.get(
            f"{self.tassi.base_url}/marketplaces/{marketplace_id}/wallet_history",
            json=expected_response,
        )

        result = self.tassi.get_marketplace_wallet_history(marketplace_id, params)
        assert result == expected_response
